...
route('#/products',()=>renderProducts(App));route('#/services',()=>renderServices(App));route('#/projects',()=>renderProjects(App));route('#/invoices',p=>renderInvoices(App,{editId:p.query.get('edit')}));route('#/invoices/new/:customerId',p=>renderInvoices(App,{newForCustomer:p.customerId}));route('#/invoices/:id',p=>renderInvoiceDetail(App,p));
route('#/accounting',()=>renderAccounting(App));route('#/reports',p=>renderReports(App,p));route('#/settings',()=>renderSettings(App));
